...
class TrainerControllerTest {
    ...
    void register_createsTrainerAndReturnsCredentials() throws Exception {
        ...
        Trainer entity = mock(Trainer.class);
        ...
        RegistrationResult<Trainer> result = new RegistrationResult<>(saved, "genPass456");
        ...
        when(trainerService.create(entity)).thenReturn(result);
        ...
        mockMvc.perform(post("/api/v1/trainers")
                ...
                .andExpect(jsonPath("$.password").value("genPass456"));

        verify(entity).setSpecialization(specialization);
    }
    ...
    @Test
    void updateStatus_returnsBadRequestWhenPathAndBodyUsernameMismatch() throws Exception {
        ActivateDeactivateRequest request = new ActivateDeactivateRequest("other.user", true);
